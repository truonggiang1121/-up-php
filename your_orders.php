...
<body>
	...
	if (!mysqli_num_rows($query_res) > 0) {
		echo '<td colspan="6"><center>Bạn chưa có đơn hàng nào được đặt </center></td>';
	} else {
		...
		while ($row = mysqli_fetch_array($query_res)) {
			...
			if ($status == "" or $status == "NULL") {
												...
												<button type="button" class="btn btn-info"><span class="fa fa-bars"
														aria-hidden="true"></span> Đơn hàng đã gữi đi!</button>
												<?php
			}
			if ($status == "in process") { ?>
												<button type="button" class="btn btn-warning"><span
														class="fa fa-cog fa-spin" aria-hidden="true"></span> Trên đường
													giao hàng!</button>
												<?php
			}
			if ($status == "closed") {
			...
			if ($status == "rejected") {
												...
												<button type="button" class="btn btn-danger"> <i
														class="fa fa-close"></i> Đã hủy đơn hàng!</button>
												<?php
			}
                                                ?>
											...
											<td data-column="Action"> <a
													...
													onclick="return confirm('Bạn có chắc chắn muốn hủy đặt hàng của bạn?');"
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-4 address color-gray">
						...
						<h5>Phone: 0384957740</a></h5>
					</div>
					<div class="col-xs-12 col-sm-5 additional-info color-gray">
						<h5>Thông tin</h5>
						<p>Tham gia cùng hàng ngàn nhà hàng khác, những người được hưởng lợi từ việc hợp tác với chúng
							tôi.</p>
					</div>
				</div>
			</div>

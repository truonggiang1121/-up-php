            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Đặt đồ ăn</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Giao tận nơi hoặc mang đi</a></li>

...
if(isset($_POST['submit'] )) 
{
	...
	{
      echo "<script>alert('Mật khẩu phải >=6');</script>"; 
	}
    ...
    {
          echo "<script>alert('Địa chỉ email không hợp lệ, vui lòng nhập một email hợp lệ!');</script>"; 
    }
	elseif(mysqli_num_rows($check_username) > 0) 
     {
       echo "<script>alert('Tên đăng kí đã được sử dụng!');</script>"; 
     }

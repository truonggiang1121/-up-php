...
function function_alert() { 
    ...
    echo "<script>alert('Cảm ơn bạn. Đơn đặt hàng của bạn đã được đặt thành công !');</script>"; 
	...
	header('location:login.php');
												...
												$item_total += ($item["price"]*$item["quantity"]);
													...
													$SQL="insert into users_orders(u_id,title,quantity,price) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','".$item["price"]."')";
                                                        ...
                                                        unset($item["quantity"]);
                                                        unset($item["price"]);
														$success = "Cảm ơn bạn. Đơn đặt hàng của bạn đã được đặt thành công !";
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item "><span>2</span><a href="#">Chọn sản phẩm yêu thích</a></li>
                                        ...
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="mod"  type="radio" value="paypal" disabled class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Thanh toán quốc tế <img src="images/paypal.jpg" alt="" width="90"></span> </label>
                                            </li>
                                        </ul>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Địa chỉ</h5>
                                    <p>Phường Tân Phú, Quận 9, Thành phố Hồ Chí Minh</p>
                                    <h5>Phone: 0384957740</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Thông tin</h5>
                                   <p>Tham gia cùng hàng ngàn nhà hàng khác, những người được hưởng lợi từ việc hợp tác với chúng tôi.</p>
                                </div>
                            </div>
                        </div>
                    </div>
